...
| `Navbar` | Cristal sticky con sombra al hacer scroll, links en píldora, submenús (`NavItem.children`) con hover, clic y teclado, teléfono, CTA con flecha, menú móvil con grupos | Cabecera. "Servicios" despliega Auditoría energética y Servicios de ingeniería |
