import {
  ...
  Heading, Text, Label, Button, SectionHeader,
  CalendarIcon, HomeIcon,
  AwardIcon, SettingsIcon, FactoryIcon, BuildingIcon, LandmarkIcon, ShieldIcon, CheckCircleIcon,
} from '@ds'
...
export function Auditoria() {
  return (
    <>
      <Navbar items={NAV('servicios')} ctaHref={ROUTES.contacto} phone={SITE.phone} phoneHref={SITE.phoneHref} />
      ...
      <Hero
        ...
        eyebrow="Servicios"
        title={<>Auditoría <Em tone="highlight">Energética</Em></>}
      >
          ...
          <Stack gap={12}>
            <Reveal>
              <SectionHeader
                ...
                title={<>Impulsando la eficiencia energética: soluciones integrales de <Em tone="brand">EcoStore</Em></>}
            ...
            <Grid columns={2} gap={6} className={styles.twoCols}>
              <Reveal>
                <Card padding="lg" className={styles.block}>
                  <Row gap={4}>
                    <IconCircle tone="soft" size="md"><AwardIcon size={22} /></IconCircle>
                    <Heading level="h3">Cualificación ESCO</Heading>
                  </Row>
                  <Checklist items={[
                    'Como la primera Empresa de Servicios Energéticos (ESCO) de Puerto Rico, EcoStore posee cualificaciones y certificaciones líderes en la industria en gestión y conservación de energía.',
              ...
              <Reveal delay={80}>
                <Card padding="lg" className={styles.block}>
                  <Row gap={4}>
                    <IconCircle tone="soft" size="md"><SettingsIcon size={22} /></IconCircle>
              ...
              <Card variant="mint" padding="lg">
                <div className={styles.sectors}>
                  <Stack gap={2}>
                    ...
                    <Heading level="h4" as="h3" tone="brand">Auditorías energéticas para toda la isla</Heading>
                    <Text size="sm">Evaluación verde gratuita: analizamos tu consumo y te presentamos opciones con números.</Text>
                  </Stack>
                  <TrustList className={styles.sectorList}>
                    <TrustItem light layout="horizontal" icon={<FactoryIcon size={20} />} title="Industrial" />
                    <TrustItem light layout="horizontal" icon={<BuildingIcon size={20} />} title="Comercial" />
                    <TrustItem light layout="horizontal" icon={<LandmarkIcon size={20} />} title="Gubernamental" />
                    <TrustItem light layout="horizontal" icon={<HomeIcon size={20} />} title="Residencial" />
                  </TrustList>
                </div>
              </Card>
            </Reveal>
          ...
          <Reveal>
            <div className={styles.why}>
              <Stack gap={3}>
                ...
                <Heading level="h2" tone="inverse">Medimos antes de <Em tone="highlight">recomendar</Em></Heading>
                <Text tone="inverseMuted">Una auditoría convierte la factura en un plan: qué cambiar, cuánto cuesta, cuánto ahorra y en cuánto tiempo se paga. Sin medición, cualquier propuesta es una apuesta.</Text>
              </Stack>
              <ul className={styles.whyList}>
                <li><CheckCircleIcon size={18} /> Evaluación inicial gratuita y sin compromiso</li>
                <li><CheckCircleIcon size={18} /> Orientación en el reembolso de eficiencia energética de LUMA</li>
                <li><CheckCircleIcon size={18} /> Opciones de financiamiento, incluido EaaS al 100%</li>
                <li><ShieldIcon size={18} /> Más de 20 años de experiencia en Puerto Rico</li>
              </ul>
            </div>
          </Reveal>
        </Container>
