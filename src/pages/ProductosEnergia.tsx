...
const FEATURED = [
  ...
  {
    src: energia("lavaseca.webp"),
    alt: "Lavadora y secadora",
    name: "Electrodomésticos eficientes",
    description:
      "Refrigeradores, lavadoras, secadoras y estufas de inducción GE, Café y Haier.",
    bg: "#2E9E3E",
  },
  {
    src: energia("microinversor.webp"),
